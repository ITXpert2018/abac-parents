...
let ChildAddPageModule = class ChildAddPageModule {
};
...
let ChildAddPage = class ChildAddPage {
    constructor(alert, db, auth, afDatabase, router, camera, file, loadingService, route) {
        this.alert = alert;
        this.db = db;
        this.auth = auth;
    ...
    ionViewWillEnter() {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_9__["database"]().ref('/schools/').once('value', (snapshot) => {
            this.schools = [];
...
//# sourceMappingURL=child-add-child-add-module-es2015.js.map