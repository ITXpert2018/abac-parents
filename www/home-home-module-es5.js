...
var HomePage = /** @class */ (function () {
    function HomePage(alert, authService, loadingService, router, storage) {
        this.alert = alert;
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.authService.user$.subscribe(function (result) {
            //console.log(result);
            // if (this.loadingService.isLoading)
            //   this.loadingService.dismiss();
            if (result) {
                _this.storage.get('newUser').then(function (newUser) {
    ...
    HomePage.prototype.checkEmail = function () {
        var _this = this;
        if (this.email == "" || this.email == undefined) {
            this.alert.customMessage("Please enter email");
        }
        else {
            this.loadingService.present().then(function () {
                console.log(_this.email);
                _this.authService.signIn(_this.email, " ").then(function (res) {
                    //if (this.loadingService.isLoading) {
                    ...
                    _this.loadingService.dismiss().then(function () {
                        ...
                        if (err.code == 'auth/user-not-found') {
                            ...
                            _this.storage.set('newUser', newUser).then(function () {
                                //go to new password
                            ...
                            var existingUser = {};
                            existingUser.email = _this.email;
                            _this.storage.set('existingUser', existingUser).then(function () {
                                _this.router.navigate(['/password-modal']);
                            });
                        }
                        else if (err.code == 'auth/invalid-email') {
                            _this.alert.customMessage("Please enter a valid email address!");
                        }
                        else {
                            _this.alert.customMessage(err.message);
                        }
