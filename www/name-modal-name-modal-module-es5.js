...
var NameModalPageModule = /** @class */ (function () {
    function NameModalPageModule() {
    }
...
var NameModalPage = /** @class */ (function () {
    function NameModalPage(alert, storage, router) {
        this.alert = alert;
        this.storage = storage;
        this.router = router;
    }
    NameModalPage.prototype.ngOnInit = function () {
    };
    NameModalPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        this.storage.get('newUser').then(function (user) {
            ...
            console.log(user);
            _this.newUser = user;
            _this.fullName = _this.newUser.fullName;
        });
    };
    NameModalPage.prototype.goToPhone = function () {
    ...
    NameModalPage.ctorParameters = function () { return [
...
//# sourceMappingURL=name-modal-name-modal-module-es5.js.map