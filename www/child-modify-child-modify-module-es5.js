...
var ChildModifyPageModule = /** @class */ (function () {
    function ChildModifyPageModule() {
    }
...
var ChildModifyPage = /** @class */ (function () {
    function ChildModifyPage(alert, db, auth, router, camera, file, loadingService, route) {
        this.alert = alert;
        this.db = db;
        this.auth = auth;
        this.router = router;
    ...
    ChildModifyPage.prototype.ngOnInit = function () {
    };
    ChildModifyPage.prototype.schoolSelected = function (event) {
        console.log(event.detail.value);
        this.child.schoolName = this.schools.find(function (x) { return x.id == event.detail.value; }).name;
    };
    ChildModifyPage.prototype.ionViewWillEnter = function () {
    ...
    ChildModifyPage.prototype.aminesSwitch = function () {
    ...
    ChildModifyPage.prototype.lactoseSwitch = function () {
    ...
    ChildModifyPage.prototype.uploadPhoto = function () {
    ...
    // FILE STUFF
    ChildModifyPage.prototype.makeFileIntoBlob = function (_imagePath) {
        var _this = this;
   ...
   */
    ChildModifyPage.prototype.uploadToFirebase = function (_imageBlobInfo) {
        var _this = this;
    ...
    ChildModifyPage.ctorParameters = function () { return [
...
//# sourceMappingURL=child-modify-child-modify-module-es5.js.map