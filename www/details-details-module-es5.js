...
var DetailsPage = /** @class */ (function () {
    function DetailsPage(auth, db, camera, file, alert, loadingService, router, afDatabase) {
        this.auth = auth;
        this.db = db;
        this.camera = camera;
        this.file = file;
    ...
    DetailsPage.prototype.ionViewWillEnter = function () {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_6__["database"]().ref('/parents/').once('value', function (snapshot) {
            snapshot.forEach(function (snap) {
                if (snap.val().uid == _this.auth.getUid()) {
                    _this.parent = snap.val();
                    _this.parentAutokey = snap.key;
   ...
   */
    ...
    DetailsPage.prototype.gotoCreditCard = function () {
        this.router.navigate(['/credit-card']);
    };
    DetailsPage.prototype.gotoTicket = function () {
