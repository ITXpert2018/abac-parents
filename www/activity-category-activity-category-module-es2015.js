...
let ActivityCategoryPageModule = class ActivityCategoryPageModule {
};
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.myChildren.length > 0) {
                ...
                if (shouldUpdateToFirebase) {
                    ...
                    // });
                    // return await modal.present();
                    yield this.enrollToActivityStoreFirebase(child, activity);
                }
            }
        });
    }
...
//# sourceMappingURL=activity-category-activity-category-module-es2015.js.map