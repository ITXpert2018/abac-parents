...
var ConversationPage = /** @class */ (function () {
    function ConversationPage(router, activatedRoute, auth, afDatabase, db) {
        this.router = router;
    ...
    ConversationPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.inp_text = '';
        firebase__WEBPACK_IMPORTED_MODULE_6__["database"]().ref('/parents/').once('value', function (snapshot) {
            snapshot.forEach(function (snap) {
                if (snap.val().parentId == _this.auth.getUid())
                    _this.parent = snap.val();
            });
        });
        // //get all messages
