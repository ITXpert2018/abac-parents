...
var ConversationPage = /** @class */ (function () {
    function ConversationPage(router, auth, db) {
        this.router = router;
        this.auth = auth;
        this.db = db;
        this.parent = {};
    ...
    ConversationPage.prototype.ionViewWillEnter = function () {
        ...
        //get all messages
        this.db.collection('parents').doc(this.auth.getUid()).collection('messages', function (q) { return q.orderBy('timestamp', 'asc'); }).snapshotChanges().subscribe(function (serverItems) {
            _this.messages = [];
            serverItems.forEach(function (item) {
                console.log(item);
                var message = item.payload.doc.data();
    ...
    ConversationPage.prototype.sendMsg = function () {
    ...
    ConversationPage.prototype.goToDetails = function () {
        this.router.navigate(['/details']);
    };
    ConversationPage.prototype.goToMyChild = function () {
        this.router.navigate(['/my-child']);
    };
    ConversationPage.prototype.goToActivityList = function () {
